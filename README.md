...
## 🐛 Relatório de Bugs Identificados (Evidências)
...
### 1. Bypass de Autenticação (Falso Negativo)
* **Local:** Tela de Login (`/`)
...
### 2. Tela "Colmeia Forms" não renderizada (WSOD)
...
### 3. Perda de Dados Visual (Data Loss) em Itens Arquivados
...
1. Clone este repositório:
   ```bash
   git clone [https://github.com/seu-usuario/testes-e2e-cypress.git](https://github.com/seu-usuario/testes-e2e-cypress.git)